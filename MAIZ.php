...
<head>
	...
	<!-- favicon -->
	<link rel="shortcut icon" type="image/png" href="assets/img/logpng">
	<!-- google font -->
...
$sql = "SELECT * FROM productos WHERE nombre LIKE '%Maiz%'";
