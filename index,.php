			...
			<div class="row">
				...
				<div class="col-lg-4 col-md-6 mb-4 mb-lg-0">
					<div class="list-box d-flex align-items-center">
						...
						<div class="content">
							<h3>En un solo lugar sin limite de tiempo.</h3>
							<p></p>
						</div>
					</div>
				</div>
				<div class="col-lg-4 col-md-6">
					<div class="list-box d-flex justify-content-start align-items-center">
						...
						<div class="content">
							<h3>Comercio justo y redondo.</h3>
							<p></p>
						</div>
					</div>
				</div>
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-lg-4 col-md-6 text-center">
					<div class="single-product-item">
						<div class="product-image">
							<a href="ALFALPA.php"><img src="assets/img/alfalfa12.jpg" height="200" alt=""></a>
						</div>
						<h3>Alfalfa</h3>
						<p class="product-price1"><span></span>fresca</p>
						<a href="ALFALPA.php" class="cart-btn"><i class=""></i> VER PRODUCTOS</a>
					</div>
				</div>
				<div class="row">
				<div class="col-lg-4 col-md-6 text-center">
					<div class="single-product-item">
						<div class="product-image">
							<a href="Trigo.php"><img src="assets/img/trigo.png" height="200" alt=""></a>
						</div>
						<h3>TRIGO</h3>
						<p class="product-price1"><span></span>Trigo</p>
						<a href="Trigo.php" class="cart-btn"><i class=""></i>VER PRODUCTOS</a>
					</div>
				</div>
				<div class="col-lg-4 col-md-6 text-center">
					<div class="single-product-item">
						<div class="product-image">
							<a href="Chile.php"><img src="assets/img/chile.avif" height="200" alt=""></a>
						</div>
						<h3>CHILE</h3>
						<p class="product-price1"><span></span>Jalapeño,poblano,serrano,chilaca,güero,de árbol</p>
						<a href="Chile.php" class="cart-btn"><i class=""></i> VER PRODUCTOS</a>
					</div>
				</div>
				<div class="col-lg-4 col-md-6 offset-md-3 offset-lg-0 text-center">
					<div class="single-product-item">
						<div class="product-image">
							<a href="Agave.php"><img src="assets/img/agave.jpg" height="200" alt=""></a>
						</div>
						<h3>AGAVE</h3>
						<p class="product-price1"><span></span>Agave</p>
						<a href="Agave.php" class="cart-btn"><i class=""></i> VER PRODUCTOS</a>
					</div>
				</div>
				...
				<div class="col-lg-4 col-md-6 text-center">
					<div class="single-product-item">
						<div class="product-image">
							<a href="Maiz.php"><img src="assets/img/maiz1.jpg" height="200px" alt=""></a>
						</div>
						<h3>Maíz</h3>
						<p class="product-price1"><span></span>MORADO, AMARILLO, CRIOllO</p>
						<a href="Maiz.php" class="cart-btn"><i class=""></i>VER PRODUCTOS</a>
					</div>
				</div>
				<div class="col-lg-4 col-md-6 text-center">
					<div class="single-product-item">
						<div class="product-image">
							<a href="Frijol.php"><img src="assets/img/frijoles.jpg" height="200" alt=""></a>
						</div>
						<h3>Frijol</h3>
						<p class="product-price1"><span></span> PINTO, NEGRO, ALUBIA</p>
						<a href="Frijol.php" class="cart-btn"><i class=""></i> VER PRODUCTOS</a>
					</div>
				</div>
				<div class="col-lg-4 col-md-6 offset-md-3 offset-lg-0 text-center">
					<div class="single-product-item">
						<div class="product-image">
							<a href="Tomate.php"><img src="assets/img/tomate.jpg" height="200px" alt=""></a>
						</div>
						<h3>Tomate</h3>
						<p class="product-price1"><span></span>TOMATE</p>
						<a href="Tomate.php" class="cart-btn"><i class=""></i> VER PRODUCTOS</a>
					</div>
				</div>
			</div>
		</div>
...
<div class="product-section mt-150 mb-150">
	...
	<div class="copyright">
		<div class="container">
			<div class="row">
				<div class="col-lg-6 col-md-12">
					<p><a href="https://imransdesign.com/">AGRO.COM</a><br><a href="https://themewagon.com/"></a>
					</p>
				</div>
