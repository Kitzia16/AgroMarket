...
$sql = "SELECT * FROM productos WHERE nombre LIKE '%Lechuga%'";
...
if ($result->num_rows > 0) {
    while ($row = $result->fetch_assoc()) {
        ...
        echo '<a href="single_product1.php?id=' . $row['id'] . '" class="cart-btn"><i class="fas fa-shopping-cart"></i> Add to Cart</a>';
        echo '</div>';
        echo '</div>';
    }
} else {
