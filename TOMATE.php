...
<head>
	...
	<!-- favicon -->
	<link rel="shortcut icon" type="image/png" href="assets/img/lpng">
	<!-- google font -->
...
$sql = "SELECT * FROM productos WHERE nombre LIKE '%Tomate%'";
...
if ($result->num_rows > 0) {
    while ($row = $result->fetch_assoc()) {
        ...
        echo '<a href="single_product1.php?id=' . $row['id'] . '" class="cart-btn"><i class="fas fa-shopping-cart"></i> Ver detalles</a>';
        echo '</div>';
        echo '</div>';
    }
} else {
